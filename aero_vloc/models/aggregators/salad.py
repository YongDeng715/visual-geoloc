...
try:
    ...
    warnings.warn("xFormers is not available. Model will run without xFormers optimizations.")

# 如果 xFormers 可用，配置 DINOv2 使用它
if XFORMERS_AVAILABLE:
    torch.hub.set_dir('/mnt/d/torch_cache/hub')
    torch.hub.help('facebookresearch/dinov2', 'dinov2_vitb14', force_reload=True)

### SALAD Aggregator Module from [SALAD](https://github.com/serizba/salad)
